                ...
                if( event_date.getDate() == view_date.getDate()
                    ...
                    .append(
                      '<div class="dropdown">'+
                        ...
                        '<span class="icon icon-waitlist">'+i+'</span>'+
                          '<span class="dropdown-toggle"  id="dd_'+i+'" data-toggle="dropdown"></span>'+                        
                        '<ul class="dropdown-menu" role="menu" aria-labelledby="dd_'+i+'">'+
                          '<li>'+this.title +'</li>'+
                        '</ul>'+
			...
			*/
            ...
            $.each(events.full, function(){
                ...
                if( event_date.getDate() == view_date.getDate()
                  ...
                  elem.parent('div:first').find('#day_' + i)
                    .removeClass("day").removeClass("holiday")
                    .addClass('full')
                    .empty()
                    .append(
                      '<div class="dropdown">'+
                          // '<span class="icon icon-full">×</span>'+
                          '<span class="icon icon-full">'+ i +'</span>'+
                          '<span class="dropdown-toggle"  id="dd_'+i+'" data-toggle="dropdown">Full</span>'+                        
                        '<ul class="dropdown-menu" role="menu" aria-labelledby="dd_'+i+'">'+
                          '<li>'+this.title +'</li>'+
                        '</ul>'+
                      '</div>'
            ...
            $.each(events.closed, function(){
                ...
                if( event_date.getDate() == view_date.getDate()
                  ...
                  elem.parent('div:first').find('#day_' + i)
                    .removeClass('day').removeClass("holiday").removeClass("full")
                    .addClass('closed')
                    .empty()
                    .append(
                      '<div class="dropdown">'+
                        '<span class="icon icon-closed">'+i+'</span>'+
                          '<span class="dropdown-toggle"  id="dd_'+i+'" data-toggle="dropdown">Closed</span>'+  
                      '</div>'
                      );
                  ;    
                }
