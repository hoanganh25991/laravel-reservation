...
//AJAX MSG
    ...
    const AJAX_RESEND_PAYMENT_AUTHORIZATION_REQUEST_SMS = "RESEND_PAYMENT_AUTHORIZATION_REQUEST_SMS";
    const AJAX_RESEND_PAYMENT_AUTHORIZATION_REQUEST_SMS_SUCCESS = "RESEND_PAYMENT_AUTHORIZATION_REQUEST_SMS_SUCCESS";
}